...
#include "OnlineSessions/Public/Menu.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMenu() {}
// Cross Module References
	ONLINESESSIONS_API UClass* Z_Construct_UClass_UMenu();
	ONLINESESSIONS_API UClass* Z_Construct_UClass_UMenu_NoRegister();
...
// End Cross Module References
	...
	{
		P_GET_UBOOL(Z_Param_bWasSusccessful);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnStartSession(Z_Param_bWasSusccessful);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMenu::execOnDestroySession)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnDestroySession(Z_Param_bWasSusccessful);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMenu::execOnCreateSession)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnCreateSession(Z_Param_bWasSusccessful);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMenu::execMenuSetup)
	{
		...
		P_GET_PROPERTY(FStrProperty,Z_Param_PathToLobby);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MenuSetup(Z_Param_NumOfPublicCOnnections,Z_Param_TypeOfMatch,Z_Param_PathToLobby);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UMenu_MenuSetup_Statics
	{
		...
		static const UECodeGen_Private::FStrPropertyParams NewProp_PathToLobby;
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_PathToLobby = { "PathToLobby", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(Menu_eventMenuSetup_Parms, PathToLobby), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_MenuSetup_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_PathToLobby,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_MenuSetup_Statics::Function_MetaDataParams[] = {
		...
		{ "CPP_Default_PathToLobby", "/Game/Lobby" },
	...
	struct Z_Construct_UFunction_UMenu_OnCreateSession_Statics
	{
		...
		{
			bool bWasSusccessful;
		};
		static void NewProp_bWasSusccessful_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bWasSusccessful;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	void Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSusccessful_SetBit(void* Obj)
	{
		((Menu_eventOnCreateSession_Parms*)Obj)->bWasSusccessful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSusccessful = { "bWasSusccessful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(Menu_eventOnCreateSession_Parms), &Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSusccessful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnCreateSession_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnCreateSession_Statics::NewProp_bWasSusccessful,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnCreateSession_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//Callbacks for the custom delegates created on MultiplayerSessionSubSystem\n" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "Callbacks for the custom delegates created on MultiplayerSessionSubSystem" },
	};
#endif
	...
	void Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSusccessful_SetBit(void* Obj)
	{
		((Menu_eventOnDestroySession_Parms*)Obj)->bWasSusccessful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSusccessful = { "bWasSusccessful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(Menu_eventOnDestroySession_Parms), &Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSusccessful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnDestroySession_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnDestroySession_Statics::NewProp_bWasSusccessful,
	};
#if WITH_METADATA
	...
	void Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSusccessful_SetBit(void* Obj)
	{
		((Menu_eventOnStartSession_Parms*)Obj)->bWasSusccessful = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSusccessful = { "bWasSusccessful", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(Menu_eventOnStartSession_Parms), &Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSusccessful_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMenu_OnStartSession_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMenu_OnStartSession_Statics::NewProp_bWasSusccessful,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 4049724662
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 1747851337
		{ &Z_Construct_UFunction_UMenu_OnDestroySession, "OnDestroySession" }, // 4012732633
		{ &Z_Construct_UFunction_UMenu_OnStartSession, "OnStartSession" }, // 2827899916
	};
#if WITH_METADATA
	...
	template<> ONLINESESSIONS_API UClass* StaticClass<UMenu>()
	{
		return UMenu::StaticClass();
	}
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_MenuSystem_Plugins_OnlineSessions_Source_OnlineSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MenuSystem_Plugins_OnlineSessions_Source_OnlineSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 2818599478U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MenuSystem_Plugins_OnlineSessions_Source_OnlineSessions_Public_Menu_h_1689951767(TEXT("/Script/OnlineSessions"),
		Z_CompiledInDeferFile_FID_MenuSystem_Plugins_OnlineSessions_Source_OnlineSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MenuSystem_Plugins_OnlineSessions_Source_OnlineSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
